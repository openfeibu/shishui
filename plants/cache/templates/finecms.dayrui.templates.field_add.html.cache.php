					...
					<div class="form-body">
						...
						<div class="form-group">
							...
							<div class="col-md-9">
								...
								<span class="help-block"><?php echo fc_lang('选择“右侧”时，发布模型内容时字段显示在右侧部分; 当选择"手动"时，需要开发者手动调用 ');  echo '{';?>$diyfield}
								</span>
							</div>
						</div>
						<div class="form-group">
						...
						<div class="form-group">
							...
							<div class="col-md-9">
								<div class="checkbox-list">
									...
									<?php $rt = $this->list_tag("action=cache name=MEMBER.group"); if ($rt) extract($rt); $count=count($return); if (is_array($return)) { foreach ($return as $key=>$t) { ?>
